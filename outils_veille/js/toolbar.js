...
function createOnglet(id) {
    ...
    //onglet.setAttribute('class','btnClass')
    ...
    main(id);
		...
		function main(idName)
		{
			...
			else
			{
				...
				tbContainer.style.left = '582px';
				tbContainer.style.top = "90px";
				tbContainer.style.height = "48px";
				tbContainer.style.border = "solid 1px #0b126d";
				tbContainer.style.borderRadius = "5px";
				tbContainer.style.backgroundColor = "rgb(164, 216, 237)";
				tbContainer.style.boxShadow = "0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19)";
				...
				var button = mxUtils.button('Sauvegarder un diagramme', function(evt)
				{
